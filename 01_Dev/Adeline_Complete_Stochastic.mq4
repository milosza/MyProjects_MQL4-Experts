...
extern int tf_m = 1;
extern int tf_h = 15;
extern int stochastic_high = 70;
extern int stochastic_low = 30;
extern int past = 6;
...
double stochastic_main_h_1, stochastic_main_h_2, stochastic_signal_h_1, stochastic_signal_h_2, stochastic_main_h_past, stochastic_main_m_1, stochastic_main_m_2, stochastic_signal_m_1, stochastic_signal_m_2;
bool buy, sell;
...
int start() {
   ...
   sma10_1 = iMA(NULL, 0, 21, 0, MODE_EMA, PRICE_CLOSE, 1); // c
   sma10_2 = iMA(NULL, 0, 21, 0, MODE_EMA, PRICE_CLOSE, 2); // b
   sma40_1 = iMA(NULL, 0, 55, 0, MODE_EMA, PRICE_CLOSE, 1); // d
   sma40_2 = iMA(NULL, 0, 55, 0, MODE_EMA, PRICE_CLOSE, 2); // a
   
   stochastic_main_h_1 = iStochastic(NULL,tf_h,5,3,3,MODE_SMA,0,MODE_MAIN,1);
   stochastic_main_h_2 = iStochastic(NULL,tf_h,5,3,3,MODE_SMA,0,MODE_MAIN,2);
   stochastic_signal_h_1 = iStochastic(NULL,tf_h,5,3,3,MODE_SMA,0,MODE_SIGNAL,1);
   stochastic_signal_h_2 = iStochastic(NULL,tf_h,5,3,3,MODE_SMA,0,MODE_SIGNAL,2);
   stochastic_main_h_past = iStochastic(NULL,tf_h,5,3,3,MODE_SMA,0,MODE_MAIN,past);
   
   stochastic_main_m_1 = iStochastic(NULL,tf_m,5,3,3,MODE_SMA,0,MODE_MAIN,1);
   stochastic_signal_m_1 = iStochastic(NULL,tf_m,5,3,3,MODE_SMA,0,MODE_SIGNAL,1);
   
   stochastic_main_m_2 = iStochastic(NULL,tf_m,5,3,3,MODE_SMA,0,MODE_MAIN,2); 
   stochastic_signal_m_2 = iStochastic(NULL,tf_m,5,3,3,MODE_SMA,0,MODE_SIGNAL,2); 
      ...
      if(OrderType() <= OP_SELL &&  OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber) {
         ...
         if(OrderType() == OP_BUY) {
            ...
            */
            ...
            //sma10_2 > sma40_2 
            //&& sma40_1 >= sma10_1
            stochastic_main_m_2 > stochastic_signal_m_2
            && stochastic_main_m_1 <= stochastic_signal_m_1
            && stochastic_main_m_1 >= stochastic_high           
            ) 
            ...
            if (Order == SIGNAL_CLOSEBUY) {
               Print("Stoch TF ", tf_m, ": main_2 ", stochastic_main_m_2, " > signal_2 ", stochastic_signal_m_2);
               Print("Stoch TF ", tf_m, ": main_1 ", stochastic_main_m_1, " <= signal_1 ", stochastic_signal_m_1);
               Print("Close BUY");
            ...
            stochastic_main_m_2 < stochastic_signal_m_2
            && stochastic_main_m_1 >= stochastic_signal_m_1
            && stochastic_main_m_1 <= stochastic_low
            ) 
   ...
   */
   ...
   if (
      //sma40_2 > sma10_2 
      //&& sma10_1 >= sma40_1 
      //stochastic_main_h_1 > stochastic_main_h_2
      //&& stochastic_main_h_1 > stochastic_signal_h_1
      //&& stochastic_main_h_1 < stochastic_high
      //&& stochastic_main_h_1 > 20      
      stochastic_main_h_2 < stochastic_signal_h_2
      && stochastic_main_h_1 >= stochastic_signal_h_1
      && stochastic_main_h_2 <= stochastic_low   
      )
      {
         buy = True;
         sell = False;
   ...
   if (
      ...
      //stochastic_main_h_1 < stochastic_main_h_2
      //&& stochastic_main_h_1 < stochastic_signal_h_1 
      //&& stochastic_main_h_1 > stochastic_low 
      //&& stochastic_main_h_1 < 80 
      stochastic_main_h_2 > stochastic_signal_h_2
      && stochastic_main_h_1 <= stochastic_signal_h_1
      && stochastic_main_h_2 >= stochastic_high
      ) {
         buy = False;
         sell= True;}
   ...
   //Buy
   if (Order == SIGNAL_BUY) {
      Print("Stoch TF ", tf_h, ": main_2 ", stochastic_main_h_2, " < signal_2 ", stochastic_signal_h_2);
      Print("Stoch TF ", tf_h, ": main_1 ", stochastic_main_h_1, " >= signal_1 ", stochastic_signal_h_1);
      Print("Stoch TF ", tf_m, ": main_2 ", stochastic_main_m_2, " < signal_2 ", stochastic_signal_m_2);
      Print("Stoch TF ", tf_m, ": main_1 ", stochastic_main_m_1, " >= signal_1 ", stochastic_signal_m_1);
      Print("Open BUY");
      if(!IsTrade) {
