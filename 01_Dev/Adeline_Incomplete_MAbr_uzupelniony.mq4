...
double sma10_1_after_cross, sma10_2_before_cross, sma40_1_after_cross, sma40_2_before_cross;
...
int start() {
   ...
   sma10_1_after_cross = iMA(NULL, 0, 34, 0, MODE_SMMA, PRICE_CLOSE, 1); // c
   sma10_2_before_cross = iMA(NULL, 0, 34, 0, MODE_SMMA, PRICE_CLOSE, 2); // b
   sma40_1_after_cross = iMA(NULL, 0, 144, 0, MODE_EMA, PRICE_CLOSE, 1); // d
   sma40_2_before_cross = iMA(NULL, 0, 144, 0, MODE_EMA, PRICE_CLOSE, 2); //a
      ...
      if(OrderType() <= OP_SELL &&  OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber) {
         ...
         if(OrderType() == OP_BUY) {
            ...
            */
            ...
            if(sma10_2_before_cross > sma40_2_before_cross && sma40_1_after_cross >= sma10_1_after_cross) Order = SIGNAL_CLOSEBUY; // Rule to EXIT a Long trade
            ...
            if (sma40_2_before_cross > sma10_2_before_cross && sma10_1_after_cross >= sma40_1_after_cross) Order = SIGNAL_CLOSESELL; // Rule to EXIT a Short trade
   ...
   */
   ...
   if (sma40_2_before_cross > sma10_2_before_cross && sma10_1_after_cross >= sma40_1_after_cross) Order = SIGNAL_BUY; // Rule to ENTER a Long trade

   if (sma10_2_before_cross > sma40_2_before_cross && sma40_1_after_cross >= sma10_1_after_cross) Order = SIGNAL_SELL; // Rule to ENTER a Short trade
